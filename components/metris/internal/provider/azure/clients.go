...
func newClient(cluster *gardener.Cluster, logger *zap.SugaredLogger, tracelevel int, clientAuthConf AuthConfig) (Client, error) {
...
func (c *client) GetResourceGroup(name, filter string, logger *zap.SugaredLogger) (rg resources.Group, err error) {
